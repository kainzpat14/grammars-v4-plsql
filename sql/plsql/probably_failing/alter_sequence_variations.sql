...
ALTER SEQUENCE emp_seq RESTART START WITH 5000;
...
ALTER SEQUENCE invoice_seq RESTART START WITH 200000;
...
ALTER SEQUENCE fiscal_year_seq RESTART START WITH 2025;
...
ALTER SEQUENCE test_data_seq RESTART START WITH 1;

-- ALTER SEQUENCE for production migration
ALTER SEQUENCE migrated_seq
RESTART START WITH 1000000
INCREMENT BY 1
CACHE 500;
